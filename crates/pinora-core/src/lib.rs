...
pub use settings::{
    AppSettings, DEFAULT_FULL_DISPLAY_HOTKEY, DEFAULT_HISTORY_LIMIT, DEFAULT_HISTORY_MAX_BYTES,
    DEFAULT_HISTORY_RETENTION_DAYS, DEFAULT_JPEG_QUALITY, DEFAULT_OCR_CONFIDENCE_THRESHOLD,
    DEFAULT_PIN_ALWAYS_ON_TOP, DEFAULT_PIN_LIMIT, DEFAULT_PIN_OPACITY_PERCENT,
    DEFAULT_REGION_HOTKEY, HISTORY_MAX_BYTES_MAX, HISTORY_MAX_BYTES_MIN,
    HISTORY_RETENTION_DAYS_MAX, HISTORY_RETENTION_DAYS_MIN, HotkeyBinding, HotkeyCode,
    HotkeyModifiers, OcrLanguage, REGION_ALTERNATE_HOTKEY, REGION_SECONDARY_HOTKEY,
