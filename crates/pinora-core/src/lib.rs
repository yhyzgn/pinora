...
pub use settings::{
    AppSettings, DEFAULT_CLIPBOARD_HOTKEY, DEFAULT_HISTORY_LIMIT, DEFAULT_HISTORY_MAX_BYTES,
    ...
    DEFAULT_REGION_HOTKEY, DEFAULT_TOGGLE_PINS_HOTKEY, HISTORY_MAX_BYTES_MAX,
    HISTORY_MAX_BYTES_MIN, HISTORY_RETENTION_DAYS_MAX, HISTORY_RETENTION_DAYS_MIN, HotkeyBinding,
    HotkeyCode, HotkeyModifiers, OcrLanguage, SETTINGS_SCHEMA_VERSION, SettingsRepairs, ThemeMode,
};
