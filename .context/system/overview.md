...
- GitHub Actions CI `30732620836`、`30732765136`、`30732906042` 与 `30733684203` 已于 2026-08-02 在 Linux、macOS、Windows 原生 runner 通过格式、workspace 编译、严格 Clippy 和单元测试；这些运行未创建 GUI 会话，不能作为任务栏、Dock、窗口交互、KWin 行为或渲染延迟的证据。
