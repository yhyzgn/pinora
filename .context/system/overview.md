...
- GitHub Actions CI `30732620836` 已于 2026-08-02 在 Linux、macOS、Windows 原生 runner 通过格式、workspace 编译、严格 Clippy 和单元测试；该运行未创建 GUI 会话，不能作为任务栏、Dock、窗口交互或 KWin 行为的证据。
