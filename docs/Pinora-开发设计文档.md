...
| `pinora-desktop` | 贴图几何、Overlay 工具栏布局/命中、预览缓存、窗口策略/KWin、设置/历史/诊断面板、Overlay 选区读数、贴图客户区菜单、面板主题、tray 能力摘要和固定反馈 | 继续迁移 Overlay/贴图窗口适配 | 不拥有应用 EventLoop、任务线程、文件或外部进程 |
